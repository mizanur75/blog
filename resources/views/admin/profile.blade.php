        ...
        <div class="card card-primary card-outline">
            ...
            <div class="text-center">
                <img class="profile-user-img img-fluid img-circle"
                    src="{{asset('images/admin/default/admin.png')}}"
        ...
        <div class="card">
            ...
            <div class="tab-content">
                ...
                <div class="post">
                    ...
                    <img class="img-circle img-bordered-sm" src="{{asset('images/admin/default/admin.png')}}" alt="user image">
                    <span class="username">
                ...
                <div class="post">
                    ...
                    <div class="row mb-3">
                    <div class="col-sm-6">
                        <img class="img-fluid" src="{{asset('images/admin/default/admin.png')}}" alt="Photo">
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <div class="row">
                        <div class="col-sm-6">
                            <img class="img-fluid mb-3" src="{{asset('images/admin/default/admin.png')}}" alt="Photo">
                            <img class="img-fluid" src="{{asset('images/admin/default/admin.png')}}" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
